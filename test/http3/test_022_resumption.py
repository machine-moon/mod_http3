...
class TestSessionResumption:
    """H3SessionTickets controls TLS ticket issuance; H3EarlyData only warns, as OpenSSL QUIC has no server-side 0-RTT."""
    ...
    def test_006_early_data_on_warns(self, env):
        ...
        assert env.httpd_error_log.scan_recent(pattern, timeout=10), (
            "expected a warning that H3EarlyData has no effect"
        )
